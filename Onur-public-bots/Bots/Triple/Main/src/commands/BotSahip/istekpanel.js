...
const { onurxTik, onurxRed, onurxCekilis } = require("../../../../src/configs/emojis.json")
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.customId === 'istek') {
        ...
        let s1 =  interaction.fields.getTextInputValue('isteksoru1');
            interaction.reply({content: `${onurxTik} İstek/Önerin Başarıyla iletildi.`, ephemeral: true});
        ...
        const sk1 = new TextInputBuilder()
            ...
            .setPlaceholder('Örn: onurx bu işi biliyo :D.')
        ...
        interaction.reply({content: `${onurxTik} Şikayetin Başarıyla iletildi.`, ephemeral: true});
