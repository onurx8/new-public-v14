...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    message.reply({ content: `${onurxTik} ${member.toString()} üyesi, ${message.author} tarafından, \`${reason}\` nedeniyle uyarıldı! Devamında mute veya daha ağır bir ceza alacaksınız. \`(Ceza ID: #${penal.id})\``}).then((e) => setTimeout(() => { e.delete(); }, 50000));
