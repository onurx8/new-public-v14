...
const { onurxRed, onurxTik, onurxRevu} = require("../../../../src/configs/emojis.json")
const ayar = require("../../../../src/configs/ayarName.json");
module.exports = {
  conf: {
    aliases: ["unjail"],
    name: "unjail",
    help: "unjail <onurx/ID>",
  ...
  run: async (client, message,  args, embed) => {
    ...
    message.reply({ content:`${onurxTik} ${member.toString()} üyesinin jaili ${message.author} tarafından kaldırıldı!`}).then((e) => setTimeout(() => { e.delete(); }, 50000));
