...
const {onurxKalp,onurxSonsuz,onurxCeza, onurxRed} = require("../../../../src/configs/emojis.json");
...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (lastTimestamp && (now - lastTimestamp) < cooldownAmount) {
        ...
        return message.channel.send(`> ${onurxRed} **Bu komutu tekrar kullanabilmek için <t:${endCooldown}:R> beklemelisin!**`);
    }
