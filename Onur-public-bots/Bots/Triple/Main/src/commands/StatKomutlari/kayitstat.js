...
const { onurxRed, onurxTik, onurxSonsuz } = require("../../../../src/configs/emojis.json")
...
> ${onurxSonsuz} Toplam kayıt bilgisi: \`${data ? data.top : 0}\`
> ${onurxSonsuz} Toplam erkek kayıt bilgisi: \`${data ? data.erkek : 0}\`
> ${onurxSonsuz} Toplam kız kayıt bilgisi: \`${data ? data.kız : 0}\`
	`)] });
    }
    else if (args[0] === "top") {
