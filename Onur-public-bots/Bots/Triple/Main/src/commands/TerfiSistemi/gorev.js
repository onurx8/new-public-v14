...
const { onurxd2, onurxb2, onurxd1, onurxb3, onurxd3, onurxRed, onurxStaff } = require("../../../../src/configs/emojis.json")
...
module.exports = {
  ...
  **${onurxStaff} Selamlar ${member} Aşağıda Bulunan Menüden İstediğin 1 Görevi Alabilirsin!
      
  ${onurxStaff} Ses Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Ses Görevi Verir
      
  ${onurxStaff} Mesaj Görevini Alırsan 300 İla 400 Mesaj Arası 10 Saatli Süreli Mesaj Görevi Verir
      
  ${onurxStaff} Taglı Görevini Alırsan 1 İla 5 Arası 10 Saatli Süreli Taglı Görevi Verir
          
  ${onurxStaff} Kayıt Görevini Alırsan 5 İla 20 Arası 10 Saatli Süreli Kayıt Görevi Verir

  ${onurxStaff} Yayın Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Yayın Görevi Verir

  ${onurxStaff} Kamera Görevini Alırsan 60 İla 300 Dakika Arası 10 Saatli Süreli Kamera Görevi Verir
      
  ${onurxStaff} Görev Ödüllerini 20 Coin Olarak Verilir
