...
const { onurxRed, onurxTik, onurxStar, onurxRevu, onurxOk } = require("../../../../src/configs/emojis.json")
...
${onurxStar} Sesli kanallarda toplam **${topses.size}** kişi var !

${onurxOk} Public odalarda **${members.filter(m => pubID.includes(m.voice.channel.parentId)).size}** kişi var !
${onurxOk} Ses kanallarında **${tagses.size}** taglı kullanıcı var !
${onurxOk} Ses kanallarında **${yetkili}** yetkili var !

${onurxOk} Ses kanallarında **${yayın.size}** kişi yayın yapıyor !
${onurxOk} Mikrofonu kapalı: **${mik}**
${onurxOk} Kulaklığı kapalı: **${kulak}**

${onurxRevu} **Top 3 kategori sırası;**
${topCategory || 'Boş'}
`)
