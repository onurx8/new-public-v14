...
const { onurxSonsuz, onurxTik, onurxRed } = require("../../../../src/configs/emojis.json");
module.exports = {
  conf: {
    aliases: ["snipe"],
    name: "snipe",
...
${onurxSonsuz} Mesaj Sahibi: <@${data.userID}> - (\`${data.userID}\`)
${onurxSonsuz} Mesajın Yazılma Tarihi: <t:${Math.floor(data.createdDate / 1000)}:R>
${onurxSonsuz} Mesajın Silinme Tarihi: <t:${Math.floor(data.deletedDate / 1000)}:R>
`);
