...
module.exports = {
  ...
  run: async (client, message, args) => {  
    ...
    .setDescription(`${message.author} Kanal Kilidini Aktifleştirmek ve Deaktifleştirmek için butonları kullanınız. Gereksiz kullanımda onurx ile görüşmeniz sorun yaratabilir.`)
